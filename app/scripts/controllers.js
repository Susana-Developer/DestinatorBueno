...
.controller('HomeController', ['$scope', '$state', 'ngDialog', 'destinosFactory', function ($scope, $state, ngDialog, destinosFactory) {
   /* destinosFactory.query({})
        ...
        $scope.getHeader = function () {return ["ID", "Puesto Nº", "Ministerio", "Centro Directivo/OOAA", "Centro Destino", "Provincia", "Localidad", "Puesto de Trabajo", "Nivel CD", "Comp. específico",
